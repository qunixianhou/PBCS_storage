...
public class Constants {
    ...
    public static final byte[] PASSWORD_SALT = (new String("PASSWORD_SALT")).getBytes();
    public static final byte[] KDF1_SALT = (new String("KDF1_SALT")).getBytes();
    public static final byte[] KDF2_SALT = (new String("KDF2_SALT")).getBytes();
    public static final byte[] KDF3_SALT = (new String("KDF3_SALT")).getBytes();
    public static final byte[] KDF4_SALT = (new String("KDF4_SALT")).getBytes();
    ...
    public static final String KEY_ENCRYPTION_ALGORITHM = "AES/GCM/NoPadding";
    ...
    public static final String AUTH_SERVER_ADDRESS = "localhost";
    public static final int AUTH_SERVER_PORT_NUMBER = 20202;
    public static final String AUTH_SERVER_NAME = "CN=usyd.authserver,OU=authserver,O=server,L=sydney,ST=NSW,C=AU"; // 可删除，但保留不影响
}